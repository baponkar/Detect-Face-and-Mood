...
mood_classifier = cv2.dnn.readNetFromCaffe('mood_classifier.prototxt', 'mood_classifier.caffemodel')
...
def detect_mood(frame):
    ...
    for (x, y, w, h) in faces:
        ...
        blob = cv2.dnn.blobFromImage(cv2.resize(roi, (48, 48)), 1.0, (48, 48), (104.0, 177.0, 123.0))
